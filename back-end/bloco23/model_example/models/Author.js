...
// Busca uma pessoa autora específica, a partir do seu ID @param {String} id ID da pessoa autora a ser recuperado
const findById = async (id) => {
  // Repare que substituímos o id por '?' na query.
  // Depois, ao executá-lo, informamos um array com o id para o método 'execute'.
  ...
  // Utilizamos [0] para buscar a primeira linha, que deve ser a única no array de resultdos, pois estamos buscando por ID.
